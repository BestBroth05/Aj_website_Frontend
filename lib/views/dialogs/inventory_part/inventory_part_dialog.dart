...
class InventoryPartDialog extends StatefulWidget {
  final Product product;
  final Function(List<Product> components) updateParts;

  InventoryPartDialog(this.product, {required this.updateParts});

  @override
  InventoryPartDialogState createState() => InventoryPartDialogState();
}

class InventoryPartDialogState extends State<InventoryPartDialog> {
